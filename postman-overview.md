...
| **Get Shipping Info** | Shipping methods for a product, per country and currency: cost, carrier, delivery window, and free-shipping and tracking flags. |
| **Get Description** | Just the product's long-form description: sanitized HTML, plain text, and the images from the description gallery. |
